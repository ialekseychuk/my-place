...
export const bookingService = {
  /**
   * Get all bookings for a business with optional date filtering
  ...
  getBookings: async (
    ...
    let url = `${API_BASE_URL}/api/v1/businesses/${businessID}/bookings`;
    
    // Remove date filtering temporarily since it's causing issues with the API
    // The backend seems to have an issue with date filtering
